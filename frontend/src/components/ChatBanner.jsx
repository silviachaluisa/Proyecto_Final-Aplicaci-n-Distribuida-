...
const ChatBanner = ({ chatInfo, handleClick }) => {

    const handleChatClick = () => {
        handleClick(chatInfo);
    }

    return (
        <div className='flex items-center justify-evenly w-full p-3 border-b rounded-lg border-gray-300 dark:border-gray-100 dark:bg-gray-700 hover:bg-slate-800 dark:hover:bg-slate-800 cursor-pointer transition duration-300' onClick={handleChatClick}>
